...
int main(int argc, char **argv) {
  ...
  switch (argc)
  {
	case 2:
	  ...
	  output_file = "conv_output.png";
	  reference_file = "conv_reference.png";
	  break;
	case 3:
	  input_file  = std::string(argv[1]);
	...
	case 6:
	  ...
	  break;
	default:
      std::cerr << "Usage: ./convolution input_file [output_filename] [reference_filename] [perPixelError] [globalError]" << std::endl;
      exit(1);
  }
